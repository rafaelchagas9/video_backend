...
export const listVideosQuerySchema = z.object({
  ...
  hasThumbnail: z.coerce.boolean().optional(),
  isAvailable: z.coerce.boolean().optional(),
}).refine(
  (data) => {
    // Validate that min values are not greater than max values
    if (data.minWidth !== undefined && data.maxWidth !== undefined && data.minWidth > data.maxWidth) {
      return false;
    }
    if (data.minHeight !== undefined && data.maxHeight !== undefined && data.minHeight > data.maxHeight) {
      return false;
    }
    if (data.minFileSize !== undefined && data.maxFileSize !== undefined && data.minFileSize > data.maxFileSize) {
      return false;
    }
    if (data.minDuration !== undefined && data.maxDuration !== undefined && data.minDuration > data.maxDuration) {
      return false;
    }
    if (data.minBitrate !== undefined && data.maxBitrate !== undefined && data.minBitrate > data.maxBitrate) {
      return false;
    }
    if (data.minFps !== undefined && data.maxFps !== undefined && data.minFps > data.maxFps) {
      return false;
    }
